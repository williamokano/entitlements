...
const appRoutes: RouteObject[] = [
  {
    ...
    children: [
      ...
      { path: '/catalog/plans/:id', Component: lazy(() => import('@/views/app/catalog/plan')) },
      { path: '/catalog/plans/:planId/versions/:vid', Component: lazy(() => import('@/views/app/catalog/version')) },
      { path: '/catalog/addons', Component: lazy(() => import('@/views/app/catalog/addons')) },
      { path: '/catalog/addons/:id', Component: lazy(() => import('@/views/app/catalog/addon')) },
      { path: '/catalog/addons/:addonId/versions/:vid', Component: lazy(() => import('@/views/app/catalog/addon-version')) },
      { path: '/catalog/pricing', Component: lazy(() => import('@/views/app/catalog/pricing')) },
