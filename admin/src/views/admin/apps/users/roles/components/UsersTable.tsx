        ...
        <div className="flex flex-wrap items-center gap-3">
          <div className="items-center gap-3 md:flex">
            ...
            <div className="input-icon-group">
              ...
              <select className="form-select" value={(table.getColumn('role')?.getFilterValue() as string) ?? 'All'} onChange={(e) => table.getColumn('role')?.setFilterValue(e.target.value === 'All' ? undefined : e.target.value)}>
